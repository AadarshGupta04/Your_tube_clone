...
function App() {
  ...
  return (
    <Router>
      ...
      <Drawersliderbar toggledrawer={toggledrawer} toggledrawersidebar={toggledrawersidebar} ></Drawersliderbar>
      <Allroutes seteditcreatechanelbtn={seteditcreatechanelbtn} setvideouploadpage={setvideouploadpage}></Allroutes>
    </Router>
  );
}
