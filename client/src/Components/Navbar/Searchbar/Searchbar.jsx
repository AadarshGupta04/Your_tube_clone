                ...
                <div className='SearchBar_Container2'>
                    <div className='search_div'>
                        ...
                        <Link to={`/search/${Searchquery}`}>
                            <FaSearch className='searchIcon_SearchBar'></FaSearch>
                        </Link>
                        <BsMicFill className='Mic_SearchBar'></BsMicFill>
                        {Searchquery && searchlist &&
                            <Searchlist setsearchquery={setsearchquery} Titlearray={Titlearray}></Searchlist>}
                    </div>
                </div>
            </div>
        </>
